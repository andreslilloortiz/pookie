...
mkdir -p ../../compiled-python/python-3.10.11-x86_64-windows
wine python-3.10.11-amd64.exe /quiet InstallAllUsers=1 TargetDir="%CD%\..\..\..\compiled-python\python-3.10.11-x86_64-windows" PrependPath=1
